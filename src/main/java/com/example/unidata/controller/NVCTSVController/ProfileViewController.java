...
public class ProfileViewController implements Initializable {
    ...
    @FXML
    private void onStudentList(ActionEvent event) {
        loadScene("/com/example/unidata/PhanHe2/NVCTSV_View/NVCTSV_QLSinhVien.fxml", "Quản lý sinh viên", btnStudentsList);
    }

    @FXML
    private void onProfile(ActionEvent event) {
        loadScene("/com/example/unidata/PhanHe2/NVCTSV_View/NVCTSV_ProfileView.fxml", "Hồ sơ - Nhân Viên Công Tác Sinh Viên", btnUserProfile);
    }
