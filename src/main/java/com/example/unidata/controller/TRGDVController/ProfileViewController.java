...
public class ProfileViewController implements Initializable {
    ...
    @FXML
    private Button btnPhanCongList;

    @FXML
    private Button btnSignOut;

    @FXML
    private Button btnStaffsList;

    @FXML
    private Button editProfile;


    private void loadTRGDVData() {
        try {
    ...
    @FXML
    void onStaffsList(ActionEvent event) {
        loadScene("/com/example/unidata/PhanHe2/TRGDV_View/TRGDV_StaffList.fxml", "Staffs List - TRGDV", btnStaffsList);
    }
