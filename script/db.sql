...
-- GRANT ALL PRIVILEGES TO DBA_MANAGER;
...
CREATE TABLE ACCOUNT (
    ...
    VAITRO VARCHAR2(20) CHECK (VAITRO IN ('ADMIN', 'NVCB', 'GV', 'NV PDT', 'NV PKT', 'NV TCHC', 'NV CTSV', 'TRDĐV'))
);
...
CREATE TABLE NHANVIEN (
    ...
    DT VARCHAR2(15),
    VAITRO VARCHAR2(20) CHECK (VAITRO IN ('NVCB', 'GV', 'NV PDT', 'NV PKT', 'NV TCHC', 'NV CTSV', 'TRDĐV')),
    MADV VARCHAR2(10),
...
SELECT * FROM DBA_USERS WHERE USERNAME IN ('RL_NVCB', 'RL_GV');
